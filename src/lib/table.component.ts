...
import {FringdTableEditable} from './table-editable/index';
import {MdTableFor} from './table-for/index';
import {FringdTableHeader} from './table-header/index';
import {MdTableSelector} from './table-selector/index';
import {MdTableGlobalSelector} from './table-global-selector/index';
...
export class MdTable implements AfterContentInit,
    AfterViewChecked {
  @ContentChildren(FringdTableHeader) headers: QueryList<FringdTableHeader>;
  @ContentChildren(FringdTableEditable) editables: QueryList<FringdTableEditable>;
  ...
  ngAfterContentInit() {
    let x = new Set([]);
    this.headers.forEach((header: FringdTableHeader) => {
      if (header.hasWidth) {
...
export const MD_TABLE_DIRECTIVES = [
  MdTable, FringdTableEditable, MdTableFor, FringdTableHeader,
